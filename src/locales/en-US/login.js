export default {
  ...
  'app.login.verification-code-warning':
    'This project is a Demo project and will not actually send you a verification code. Please switch to the account password login interface and logger in as prompted.',
  'app.register.sign-in': 'Already have an account?',
  'app.register-result.msg': 'Account：registered at {email}',
  'app.register-result.activation-email':
    'The activation email has been sent to your email address and is valid for 24 hours. Please logger in to the email in time and click on the link in the email to activate the account.',
