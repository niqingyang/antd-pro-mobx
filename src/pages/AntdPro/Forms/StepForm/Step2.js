...
@Form.create()
@inject(({stores: {dispatch, routing, form, loading}}) => ({
    dispatch,
    routing,
    submitting: loading.actions['form/submitStepForm'],
    data: form.step,
}))
class Step2 extends React.PureComponent {
    render() {
        const {form, data, dispatch, submitting, routing} = this.props;
        const {getFieldDecorator, validateFields} = form;
        const onPrev = () => {
            routing.push('/antd-pro/form/step-form/info');
        };
